class Shape {
    ...
    // Mthd to create the str for the svg

    createShape() {
        const svg = (`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">${this.renderShape()}${this.renderText()}</svg>`)
        return svg
    }
